...
{
    class CSQLNT_DieuChinhTon
    {
        public CSQLNT_DieuChinhTon() { }
        ...
        public int Sua(CSQLNT_DieuChinhTon nt_dctk)
        {
            ...
            thamso[0].Value = nt_dctk.SDCTKid;
            thamso[1].Value = nt_dctk.SGhiChu;
            thamso[2].Value = nt_dctk.BDaXetDuyet;
            thamso[3].Value = nt_dctk.DNgayXetDuyet;
            thamso[4].Value = nt_dctk.SUserXetDuyet;

            CDuLieu dl = new CDuLieu();
            int kq = dl.ThucThiTraVeKetQuaKieuInt("NT_DieuChinhTonKho_Sua", thamso);
            return kq;
        }
        public int ThemMoi(CSQLNT_DieuChinhTon nt_dct_)
        {
            ...
            thamso[0].Value = nt_dct_.SDCTKid;
            ...
            try
            {
                int kq = dl.ThucThiTraVeKetQuaKieuInt("NT_NhanDieuChinhTonKho_ThemMoiNhanDieuChinhTonKho", thamso);
                return kq;
            }
            catch (Exception Exception) { throw Exception; }
        }
        public DataTable LoadNT_DieuChinhTonLenLuoi(bool isXemTatCa)
        {
            SqlParameter[] thamso = { new SqlParameter("@IsXemTatCa", SqlDbType.Bit) };
            thamso[0].Value = isXemTatCa;
            CDuLieu dl = new CDuLieu();
            return dl.LoadTable("NT_DieuChinhTonKho_LoadDieuChinhTonKhoLenLuoi", thamso);
        }
        ...
        public DataTable LayDieuChinhTonKhoTheoMa(string DCTKid)
        {
            ...
            try
            {
                DataTable dtb = dl.LoadTable("NT_DieuChinhTonKho_LayDieuChinhTonKhoTheoMa", thamso);
                return dtb;
            }
            catch (Exception ex)
            {
        ...
        public string LayDCTKidTheoSoPDC(string soPDC)
        {
            ...
            CDuLieu dl = new CDuLieu();
            DataTable dtb = dl.LoadTable("NT_DieuChinhTonKho_LayDCTKidTheoSoPDC", thamso);
        ...
        public DataTable LayDanhSachNT_DieuChinhTonKhoXacNhanLenLuoi(bool xong, bool xacnhan)
        {
            try
            {
                ...
                CDuLieu dl = new CDuLieu();
                DataTable dtb = dl.LoadTable("NT_DieuChinhTonKho_LoadDieuChinhTonKhoXacNhanLenLuoi", thamso);
                return dtb;
            }
            catch (Exception ex)
            {
        ...
        public int SuaThongTinDieuChinhTonKhoXacNhan(CSQLNT_DieuChinhTon nt_dctk_)
        {
            SqlParameter[] thamso = {   new SqlParameter("@DCTKid", SqlDbType.VarChar), 
            ...
            thamso[0].Value = nt_dctk_.SDCTKid;
            thamso[1].Value = nt_dctk_.BDaXacNhan;
            thamso[2].Value = nt_dctk_.DNgayXacNhan;
            thamso[3].Value = nt_dctk_.SUserXacNhan;

            CDuLieu dl = new CDuLieu();
            try
            {
                int kq = dl.ThucThiTraVeKetQuaKieuInt("NT_DieuChinhTonKho_SuaThongTinDieuChinhTonKhoXacNhan", thamso);
                return kq;
            }
            catch (Exception ex)
            {
        ...
        public string ThemMoi(CSQLNT_DieuChinhTon nt_dct_, DataTable dtChiTiet)
        {
            try {
                SqlParameter[] thamso = {  
                                        new SqlParameter("@DCTKid", SqlDbType.VarChar, 50),
                                        new SqlParameter("@SoPDC", SqlDbType.VarChar),
                                        new SqlParameter("@NgayChinh", SqlDbType.DateTime), 
                                        new SqlParameter("@NTid", SqlDbType.VarChar),
                                        new SqlParameter("@GhiChu", SqlDbType.NVarChar),
                ...
                thamso[6].Value = nt_dct_.SUserNhan;
                thamso[7].Value = nt_dct_.BHangDacBiet;
                thamso[8].Value = dtChiTiet;
                thamso[9].Direction = ParameterDirection.Output;

                CDuLieu dl = new CDuLieu();
                dl.ThucThi("NT_NhanDieuChinhTonKho_ThemMasterVaChiTiet", thamso);
        ...
        public bool KiemTraTonTai(string DCTKid)
        {
            SqlParameter[] thamso = {  
            ...
            CDuLieu dl = new CDuLieu();
            dl.ThucThi("NT_NhanDieuChinhTonKho_KiemTraTonTai", thamso);
