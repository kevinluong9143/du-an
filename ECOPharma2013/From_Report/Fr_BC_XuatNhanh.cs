...
{
    public partial class Fr_BC_XuatNhanh : Form
    {
        public Fr_BC_XuatNhanh()
        {
            InitializeComponent();
        }
        ...
        private void Fr_BC_XuatNhanh_Load(object sender, EventArgs e)
        {
            dtDenNgay.Value = DateTime.Now;
            XuLyTuNgay();
        }
        DataTable dtbxuatnhanh_ = new DataTable();
        private void btnXem_Click(object sender, EventArgs e)
        {
            ...
            CSQLXuatNhanhCT xuatnhanh_ = new CSQLXuatNhanhCT();
            dtbxuatnhanh_ = xuatnhanh_.BaoCaoXuatNhanh_LoadDSTuNgay_DenNgay(TuNgay, DenNgay);
            if (dtbxuatnhanh_ != null && dtbxuatnhanh_.Rows.Count > 0)
            {
                rgvNTTraHang.DataSource = dtbxuatnhanh_;
            }
            else
            {
        ...
        private void btnExportToExcel_Click(object sender, EventArgs e)
        {
            if (rgvNTTraHang.Rows.Count > 0)
            {
                ...
                if (f.ShowDialog() == DialogResult.OK)
                {
                    ...
                    if (qtc.KiemTraQuyenIn("Fr_BC_XuatNhanh") == false)
                    {
