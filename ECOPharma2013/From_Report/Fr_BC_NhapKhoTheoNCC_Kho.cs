...
{
    public partial class Fr_BC_NhapKhoTheoNCC_Kho : Form
    {
        public Fr_BC_NhapKhoTheoNCC_Kho()
        {
            InitializeComponent();
        ...
        private void Fr_BC_NhapKhoTheoNCC_Load(object sender, EventArgs e)
        {
        ...
        //    radMultiColumnComboBoxNCC.DataSource = npp_.LoadDSNPPLenMComboBox();
        ...
        private void btnXem_Click(object sender, EventArgs e)
        {
            ...
            //        dtbNhapKhoCT_InCty = nhapkhoct_.BaoCaoNhapKho_ChiTietTheoThang(TuNgay, DenNgay, radMultiColumnComboBoxNCC.SelectedValue.ToString());
            ...
            //    {
            //        dtbNhapKhoCT_InCty = nhapkhoct_.BaoCaoNhapKho_LoadDSTuNgay_DenNgay_NSXID(TuNgay, DenNgay, radMultiColumnComboBoxNCC.SelectedValue.ToString());
            ...
            //    rgvChiTietThang.Hide();
            //    rgvNhapKhoChiTiet.Show();
            //    // DungLV Check xem ngay tao start
            //    if (isCBNgayTao.Checked == true)
            //        dtbNhapKhoCT_InCty = nhapkhoct_.BaoCaoNhapKho_LoadDSTuNgay_DenNgay_NgayTao(TuNgay, DenNgay);
            //    else
            //        dtbNhapKhoCT_InCty = nhapkhoct_.BaoCaoNhapKho_LoadDSTuNgay_DenNgay(TuNgay, DenNgay);
            //    // DungLV Check xem ngay tao end
            //    if (dtbNhapKhoCT_InCty != null && dtbNhapKhoCT_InCty.Rows.Count > 0)
            //    {
            //        rgvNhapKhoChiTiet.DataSource = dtbNhapKhoCT_InCty;
            //    }
